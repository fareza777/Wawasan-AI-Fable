                            ...
                            "huangruiteng/loopx": {
                                                      ...
                                                      "antirez/h3.c": {
                                                                                                            ...
                                                                                                            "cathrynlavery/diagram-design": {
                                                                                                              description:
                                                                                                                "Skill untuk Claude Code, Codex, dan Pi yang menghasilkan 27 jenis diagram editorial berkualitas desainer — HTML self-contained dengan warna dan tipografi brand kamu, bukan Mermaid default yang generik.",
                                                                                                              highlights: [
                                                                                                                "27 jenis diagram (arsitektur, flowchart, sequence, ER, timeline, swimlane, quadrant, tree, dll) — semua berbasis HTML self-contained, tanpa JS, tanpa build step, tanpa gambar eksternal, sehingga portable disisipkan ke blog atau dokumen.",
                                                                                                                "Skill agentik yang membaca website kamu lalu memetakan warna dan tipografi brand ke diagram dalam 60 detik — bukan 'drop-in template', melainkan output yang konsisten dengan identitas visual situs/proyek.",
                                                                                                                "Bisa menunjuk diagram Mermaid atau draw.io yang sudah ada lalu redraw dengan format, ukuran, dan level detail yang disesuaikan dengan audiens — berguna untuk founder, technical writer, dan konsultan yang sering membuat diagram berkualitas tanpa harus buka Figma.",
                                                                                                                "Pendekatan 'editorial design' yang menolak rounded box generik: tiap node punya alasan, accent color disimpan untuk 1–2 hal yang harus dilihat pembaca duluan, target density 4/10 — bikin diagram AI terasa 'sengaja dibuat', bukan template default.",
                                                                                                              ],
                                                                                                            },
                                                                                                            "corsairdev/corsair": {
                                                                                                              description:
                                                                                                                "Lapisan integrasi terpusat untuk agen AI (TypeScript, MCP) — pasang ke Claude/Cursor/Codex dan agen langsung punya akses ke Gmail, Drive, Slack, dan 50+ tool lain tanpa pernah pegang kredensialnya, dengan permission gating yang bisa kamu audit.",
                                                                                                              highlights: [
                                                                                                                "Pendekatan 'no credential leakage': agen tidak pernah melihat token OAuth atau API key — kamu daftarkan sekali di Corsair, lalu MCP server memediasi semua panggilan dengan scoped auth, sehingga satu instruksi agen yang salah tidak langsung bocorkan akses ke semua app.",
                                                                                                                "Permission gating granular untuk setiap aksi berisiko (kirim email, hapus file, posting publik): Corsair menahan request dan menampilkan preview di link publik yang expire dalam 10 menit — kamu approve, deny, atau edit sebelum agen lanjut.",
                                                                                                                "Onboarding tool yang cepat: 50+ integrasi (Gmail, Drive, Slack, Notion, Linear, GitHub, dll) sudah built-in dengan tool call yang siap pakai — pasang MCP ke coding agent dan agen langsung bisa kueri, tulis, atau update tanpa setup integrasi manual.",
                                                                                                                "Cocok untuk power user yang ingin AI agent-nya produktif di app kerja nyata (bukan cuma di terminal) — workflow 'agen yang diawasi' dengan audit trail jelas, sehingga rasa 'memberikan kunci semua app ke AI' terasa terkontrol, bukan reckless.",
                                                                                                              ],
                                                                                                            },
                                                                                                            "semantica-agi/semantica": {
                                                                                                              description:
                                                                                                                "Infrastruktur graph-native open-source (MIT, Python) untuk bangun 'Context Graph' dan knowledge graph dari data enterprise — jalankan agen AI di atasnya dengan decision provenance penuh, biar setiap output bisa diaudit dari sumber sampai ke jawaban.",
                                                                                                              highlights: [
                                                                                                                "Disebut 'Open Source Palantir for AI Agents': ingest data enterprise (PDF, spreadsheet, dokumen, dsb), ekstrak entitas dan relasi, bangun knowledge graph dengan ontology management — bukan sekadar vector DB, melainkan graf yang paham domain dan regulasi.",
                                                                                                                "Polyglot graph storage: support RDF (W3C standards, interoperable dengan tools Semantic Web) dan LPG (Labeled Property Graph ala Neo4j) — fleksibel untuk workload berbeda, dan gampang diintegrasikan dengan pipeline data lakehouse yang sudah ada.",
                                                                                                                "Decision provenance end-to-end: setiap reasoning dan jawaban agen menyertakan jejak audit dari sumber data sampai kesimpulan — krusial untuk domain high-stakes (finance, legal, healthcare) di mana 'kenapa AI jawab begini' harus bisa dijelaskan ke regulator dan auditor.",
                                                                                                                "Self-hostable dan governable (zero vendor lock-in, MIT-licensed) — relevan untuk tim Indonesia yang menangani data sensitif dan butuh infrastruktur AI yang bisa dijalankan di server sendiri sambil tetap memenuhi standar compliance internal.",
                                                                                                                                                                                                                              ],
                                                                                                                                                                                                                            },
                                                                                                                                                                                                                            "deepseek-ai/deepseek-harness": {
                                                                                                                                                                                                                              description:
                                                                                                                                                                                                                                "Harness agen open-source resmi dari DeepSeek — arsitektur 'everything is a plugin' di atas Cordis, jalankan lewat `npx @deepseek-ai/dsh web` dan dapat Web UI siap pakai di localhost.",
                                                                                                                                                                                                                              highlights: [
                                                                                                                                                                                                                                "DeepSeek Harness (`dsh`) dari DeepSeek AI — agen harness open-source dengan filosofi 'everything is a plugin', ditenagai framework Cordis yang menjembatani event dengan lifecycle scoped.",
                                                                                                                                                                                                                                "Distribusi praktis: cukup `npx @deepseek-ai/dsh web` dan Web UI langsung jalan di http://127.0.0.1:3080 — tidak perlu clone, build, atau setup environment manual untuk coba pertama kali.",
                                                                                                                                                                                                                                "Ekosistem plugin terbuka lewat tag `dsh-plugin` di GitHub: komunitas bisa menambahkan tool, model adapter, dan middleware baru yang langsung load ke harness lewat marketplace yang sama.",
                                                                                                                                                                                                                                "Dokumentasi arsitektur dan development guide tersedia lengkap (docs/architecture.md, docs/development.md) — relevan untuk engineer Indonesia yang ingin paham fondasi 'how modern agent harness actually works' di balik hype.",
                                                                                                                                                                                                                              ],
                                                                                                                                                                                                                            },
                                                                                                                                                                                                                            "guillaumemeyer/watermarks-remover": {
                                                                                                                                                                                                                              description:
                                                                                                                                                                                                                                "Agent skill + script Python untuk menghapus watermark AI multi-vendor (Claude, Gemini/SynthID, OpenAI, C2PA) dari teks dan file — untuk konten yang Anda miliki sendiri.",
                                                                                                                                                                                                                              highlights: [
                                                                                                                                                                                                                                "Tiga lapis pertahanan: invisible Unicode/bidi/spasi eksotik (deterministik lewat Python), statistical watermarking (token-sampling) via agent rewrite, dan C2PA/EXIF/XMP metadata untuk file PNG/JPEG/SVG/PDF/DOCX/ODT/HTML/Markdown.",
                                                                                                                                                                                                                                "Mendukung multi-vendor: Claude, Gemini/SynthID-Text, OpenAI provenance, dan Kirchenbauer-style marks untuk open-LLM — bukan satu tool spesifik, melainkan utilitas universal untuk konten yang Anda buat sendiri.",
                                                                                                                                                                                                                                "Dua cara pakai: CLI langsung lewat script (`rewrite_text.py` dan kawan-kawan), atau dipasang sebagai agent skill `skills/remove-ai-marks/` ke Grok/Claude Code agar bisa dipanggil otomatis saat agent menangani konten Anda.",
                                                                                                                                                                                                                                "Lisensi eksplisit untuk konten yang Anda miliki — bukan tool untuk menghindari deteksi滥用 pihak lain, melainkan 'self-cleanup' untuk menjaga privasi dan kebersihan teks/file Anda sendiri.",
                                                                                                                                                                                                                                                                                                                                                                                                      ],
                                                                                                                                                                                                                                                                                                                                                                                                    },
                                                                                                                                                                                                                                                                                                                                                                                                    "cloudflare/security-audit-skill": {
                                                                                                                                                                                                                                                                                                                                                                                                      description:
                                                                                                                                                                                                                                                                                                                                                                                                      "Skill resmi Cloudflare yang mengubah coding agent jadi auditor keamanan terstruktur — enam fase audit dari reconnaissance sampai reporting dengan verifikasi independen, sudah dipakai Cloudflare untuk vulnerability discovery harness mereka sendiri.",
                                                                                                                                                                                                                                                                                                                                                                                                      highlights: [
                                                                                                                                                                                                                                                                                                                                                                                                          "Enam fase audit terstruktur: reconnaissance (peta arsitektur & boundary), coverage-led hunting, candidate validation dengan verifier independen, structured output ke findings.json, record verification oleh agen kedua, dan target-neutral reporting — setiap temuan punya trace sumber lengkap, bukan klaim kosong.",
                                                                                                                                                                                                                                                                                                                                                                                                          "Seed dari Cloudflare's own vulnerability discovery harness yang tumbuh jadi sistem fleet-wide: skill ini adalah starting point dari sesuatu yang sudah diuji di skala produksi Cloudflare sebelum di-open-source-kan — bobot otoritasnya tinggi untuk standar kualitas security.",
                                                                                                                                                                                                                                                                                                                                                                                                          "Attack classes komprehensif: AI/prompt-injection, supply-chain, cloud/IaC, memory-safety/binary, web protocol/auth, client-side/DOM, RPC/serialization, desktop/mobile — 14 kelas serangan berbeda dikodekan sebagai prompt terstruktur yang agent bisa ikuti secara deterministik.",
                                                                                                                                                                                                                                                                                                                                                                                                          "Install via Skills CLI (`npx skills add`) ke Claude Code, Codex, Cursor, atau agen lain — kompatibel standar agentskills.io, additive (multiple runs bertambah tanpa menimpa sebelumnya), dan output terverifikasi lewat validator zero-dependency `validate-findings.cjs`.",
                                                                                                                                                                                                                                                                                                                                                                                                      ],
                                                                                                                                                                                                                                                                                                                                                                                                    },
                                                                                                                                                                                                                                                                                                                                                                                                    "browser-use/jev-ultrafast": {
                                                                                                                                                                                                                                                                                                                                                                                                      description:
                                                                                                                                                                                                                                                                                                                                                                                                      "Browser agent berkecepatan tinggi dari Browser Use × TypeSafe dengan dynamic indexed action space — satu perintah natural language menyelesaikan tugas browsing kompleks seperti search flight Google dalam 7,1 detik.",
                                                                                                                                                                                                                                                                                                                                                                                                      highlights: [
                                                                                                                                                                                                                                                                                                                                                                                                          "Arsitektur dua keputusan per round-trip: LLM kecil pilih operation (CLICK, TYPE_TEXT, SELECT, dll) DAN element target sekaligus, lalu eksekusi langsung ke browser — hanya satu request ke TypeSafe API per aksi, bukan multi-step seperti framework browser automation tradisional.",
                                                                                                                                                                                                                                                                                                                                                                                                          "Benchmark nyata: Zürich → London pada Google Flights selesai dalam 7,1 detik (termasuk loading wait), dengan screenshot renderer yang menambahkan labels setelah aksi dieksekusi — driver-nya tidak menghasilkan teks generik, melainkan benar-benar mengetik nama kota yang relevan.",
                                                                                                                                                                                                                                                                                                                                                                                                          "Tidak butuh site-specific scripts: agent diberi satu goal natural language, kemudian beroperasi tanpa field strings atau prepared strategies — contoh flights hanya supply goal dan verify outcome setelah pencarian selesai, tanpa hard-coded navigasi.",
                                                                                                                                                                                                                                                                                                                                                                                                          "Library Python `Agent` dengan context manager, loop stateful, dan Inspector UI di localhost:8766 — support Gemini, GLM, DeepSeek via OpenAI-compatible text helper; Chrome terhubung via Browser Harness bawaan. Lisensi open-source, relevan untuk developer Indonesia yang mau browser automation super cepat tanpa Selenium/Playwright overhead.",
                                                                                                                                                                                                                                                                                                                                                                                                      ],
                                                                                                                                                                                                                                                                                                                                                                                                    },
                                                                                                                                                                                                                                                                                                                                                                                                    "wide-trace/open-higgsfield": {
                                                                                                                                                                                                                                                                                                                                                                                                      description:
                                                                                                                                                                                                                                                                                                                                                                                                      "Studio open-source gratis untuk generate gambar dan video dari 38 model AI — pengganti Higgsfield AI yang self-hosted, bebas subscription, dan menyatukan prompt bar tunggal untuk semua model image + video.",
                                                                                                                                                                                                                                                                                                                                                                                                      highlights: [
                                                                                                                                                                                                                                                                                                                                                                                                          "Single studio approach: satu prompt bar mengontrol 38 model (8 image + 30 video) termasuk Soul 2, Seedance 2.5, Kling 3, Wan, Flux, Ideogram, Grok, Qwen — tiap model punya per-setting native (aspect ratio, duration, resolution, batch size) yang dirender otomatis sesuai kemampuan model.",
                                                                                                                                                                                                                                                                                                                                                                                                          "Gallery masonry dengan empat scope (Image, Video, Assets, Favorites) — tile menampilkan real run dengan true aspect ratio, reusable prompt/model/settings, bulk actions (download/favorite/delete), dan viewer detail lengkap dengan download link asli dari CDN.",
                                                                                                                                                                                                                                                                                                                                                                                                          "Next.js 16 + React 19 + plain CSS + Zustand, deploy ke Vercel dengan server action untuk host key aman (httpOnly cookie) — history persist di IndexedDB 60 records, failed/canceled runs tercatat dengan alasan dan retry satu klik.",
                                                                                                                                                                                                                                                                                                                                                                                                          "Hosted version gratis di openhiggsfield.ai tanpa install, clone repo untuk self-hosted penuh — kunci platform milik user sendiri (id:secret format), bukan shared quota SaaS. Relevan untuk creator Indonesia yang ingin akses multi-model image/video generation tanpa bayar langganan Studio Higgsfield.",
                                                                                                                                                                                                                                                                                                                                                                                                      ],
                                                                                                                                                                                                                                                                                                                                                                                                    },
                                                                                                                                                                                                                            "cactus-compute/needle": {
                                                                                                                                                                                                                              description:
                                                                                                                                                                                                                                "Model AI kecil 45M parameter untuk tool calling dan device use — hanya 14MB binary, jalan di RAM ~28MB, dipasang via `pip install cactus-needle` untuk on-device AI tanpa cloud.",
                                                                                                                                                                                                                              highlights: [
                                                                                                                                                                                                                                "Needle 2: model 45M parameter dari Cactus Compute yang didesain khusus untuk tool calling, device use, dan structured extraction — binary 14MB, full session dalam ~28MB RAM, kompresi CQ2-bit lewat Cactus Quants.",
                                                                                                                                                                                                                                "Arsitektur 'Simple Attention Network' (SAN) yang menggantikan FFN dengan Hadamard MLP, plus GQA attention, engram key-value memory, dan multi-lane hyper-connections — fondasi riset yang dipublikasikan ke arXiv (2607.18363).",
                                                                                                                                                                                                                                "Contract sederhana: deklarasi tool, Needle panggil dengan struktur JSON out, dan setiap respons membawa confidence score ter-kalibrasi — set threshold, act kalau yakin, escalate kalau tidak.",
                                                                                                                                                                                                                                "Use case langsung untuk developer Indonesia: bangun asisten on-device di smartphone, wearable, smart home, atau robot tanpa kirim data ke cloud — relevan untuk aplikasi kesehatan/keuangan yang butuh privasi lokal.",
                                                                                                                                                                                                                              ],
                                                                                                                                                                                                                            },
                                                                                                                                                                                                                            "public-apis/public-apis": {
                                                                                                                                                                                                                              description:
                                                                                                                                                                                                                                "Daftar kurasi terlengkap untuk API publik gratis — 1400+ endpoint dari kategori Animals, Finance, Games, Music, dan lain-lain, dikurasi komunitas untuk prototyping dan side project.",
                                                                                                                                                                                                                                highlights: [
                                                                                                                                                                                                                                  "Repositori legendaris 'awesome list' untuk API publik gratis — lebih dari 1400 endpoint dikurasi komunitas lintas kategori (animals, art, crypto, finance, games, music, weather, dll), dipakai lebih dari 458 ribu bintang sebagai titik awal side project.",
                                                                                                                                                                                                                                  "Mendukung filter berdasarkan 'API Key是否 perlu' dan 'HTTPS是否支持' lewat badge di README — developer bisa langsung skip API yang butuh langganan mahal saat eksplorasi.",
                                                                                                                                                                                                                                  "Berguna untuk MVP, demo, dan eksperimen cepat: pilih endpoint, baca deskripsi singkatnya, lalu lanjut ke dokumentasi resmi vendor tanpa harus riset dari nol.",
                                                                                                                                                                                                                                  "Aktivitas harian tetap tinggi karena kontributor rutin menambahkan API baru — relevan untuk founder Indonesia, maker, dan engineer yang butuh 'direktori API' tepercaya untuk side project tanpa harus bangun sendiri.",
                                                                                                                                                                                                                                ],
                                                                                                                                                                                                                            },
                                                                                                                                                                                                                            "xai-org/x-algorithm": {
                                                                                                                                                                                                                              description:
                                                                                                                                                                                                                                "Source code resmi algoritma 'For You' feed X (dulu Twitter) dari xAI — kode production yang menggabungkan in-network content dengan retrieval ML out-of-network, filter, lalu ranking pakai transformer.",
                                                                                                                                                                                                                                highlights: [
                                                                                                                                                                                                                                  "Repositori resmi xAI yang mempublikasikan algoritma inti 'For You' feed X — bukan sekadar penjelasan marketing, melainkan kode Rust production yang dipakai untuk memilih post yang dilihat 500+ juta pengguna setiap hari.",
                                                                                                                                                                                                                                  "Arsitektur pipa tiga tahap yang eksplisit: retrieval kandidat dari in-network (akun yang di-follow) dan out-of-network (ML-based retrieval), filter berdasarkan signal seperti blocks/mutes/reposts, lalu ranking transformer dengan bobot multi-signal (predicted likes, replies, dll).",
                                                                                                                                                                                                                                  "Update terbaru (Agustus 2026) menambah parameter konfigurasi bobot scoring dan transparansi label — xAI memberi 'insight' bagaimana feed dibentuk, bukan lagi sealed black box seperti algoritma lama.",
                                                                                                                                                                                                                                  "Berguna untuk engineer AI/ML Indonesia yang riset recommender system skala besar: kode ini jadi 'peta jalan nyata' tentang trade-off latency/quality, real-time serving, dan feature engineering yang dipakai di production-grade feed.",
                                                                                                                                                                                                                                ],
                                                                                                                                                                                                                            },
                                                                                                                                                                                                                            "cordiverse/cordis": {
                                                                                                                                                                                                                              description:
                                                                                                                                                                                                                                "Framework TypeScript ringan untuk bot/agen dengan arsitektur plugin & event-driven — fondasi di balik DeepSeek Harness, dipasang via npm dan ditulis dengan filosofi 'everything is a plugin'.",
                                                                                                                                                                                                                                highlights: [
                                                                                                                                                                                                                                  "Meta-framework TypeScript untuk bot/agen yang menjembatani event dengan lifecycle scoped — arsitektur 'everything is a plugin' memungkinkan developer menambah/mencabut kapabilitas tanpa edit core.",
                                                                                                                                                                                                                                  "Menjadi tulang punggung DeepSeek Harness (`dsh`) yang sedang trending — memahami Cordis = memahami fondasi salah satu agen open-source paling aktif dipakai komunitas AI Indonesia saat ini.",
                                                                                                                                                                                                                                  "Dukungan multi-protocol transport dan event bus yang scalable — awalnya dirancang untuk chatbot, tapi pattern plugin-nya diadopsi untuk harness agen modern karena lifecycle management-nya sederhana dan battle-tested.",
                                                                                                                                                                                                                                  "Berlisensi开放 source dan terdistribusi via npm (`cordis`) — relevan untuk developer TypeScript yang ingin bangun harness, bot framework, atau platform plugin-driven sendiri dengan fondasi yang sudah teruji di production.",
                                                                                                                                                                                                                                ],
                                                                                                                                                                                                                            },
                                                                                                                                                                                                                            "anywhere-labs/deepseek-harness-desktop": {
                                                                                                                                                                                                                              description:
                                                                                                                                                                                                                                "Wrapper desktop Electron dari DeepSeek Harness — instal satu klik, langsung pakai tanpa setup, mendukung macOS dan Windows untuk pengguna yang lebih nyaman dengan aplikasi GUI.",
                                                                                                                                                                                                                              highlights: [
                                                                                                                                                                                                                                  "Antarmuka desktop (Electron) untuk DeepSeek Harness — installer `.dmg` untuk macOS dan `.exe` untuk Windows, tidak perlu install Node.js, pnpm, atau dependency per command line.",
                                                                                                                                                                                                                                  "Mendukung semua fitur resmi `dsh` (Web UI, plugin manager, skill catalog) lewat jendela aplikasi native — pengalaman yang familier untuk pengguna Claude Desktop, ChatGPT app, atau Cursor, bukan terminal-only.",
                                                                                                                                                                                                                                  "Auto-update dan notifikasi rilis — saat DeepSeek Harness rilis versi baru, desktop app mengambil update otomatis sehingga developer tidak perlu cek GitHub secara manual.",
                                                                                                                                                                                                                                  "Bagian dari ekosistem resmi DeepSeek Harness — relevan untuk power user non-CLI, tim enterprise yang butuh distribusi internal, dan siapa saja yang ingin 'satu app instead of seven terminal commands' tanpa kehilangan fleksibilitas harness.",
                                                                                                                                                                                                                                ],
                                                                                                                                                                                                                            },
                                                                                                                                                                                                                            "liustack/modlens": {
                                                                                                                                                                                                                              description:
                                                                                                                                                                                                                                "Plugin vision pertama untuk DeepSeek Harness — tempel gambar di chat dan model text-only DeepSeek/GLM langsung bisa membaca lewat structured JSON evidence (OCR, layout, semantik).",
                                                                                                                                                                                                                              highlights: [
                                                                                                                                                                                                                                  "Plugin vision pertama untuk DeepSeek Harness (`dsh`) — sekali pakai lewat `npx -y @deepseek-ai/dsh plugin --profile web add @liustack/modlens`, model text-only DeepSeek/GLM yang terpasang langsung punya native tool `modlens_read_image`.",
                                                                                                                                                                                                                                  "Zero-config di harness lokal: tidak butuh hook, wrapper, proxy daemon, atau edit config — di skill harness (Claude Code, Codex, OpenCode, Pi) cuma satu folder skill, di dsh cukup satu plugin. Uninstall = hapus folder, agen kembali ke stock.",
                                                                                                                                                                                                                                  "Output terstruktur: full transcription, reading-order layout regions, daftar entity dan relasi — model tidak mengarang, melainkan mengutip spesifik dari bukti visual yang diberikan plugin.",
                                                                                                                                                                                                                                  "Auto-discovery: plugin mendeteksi route DeepSeek/GLM text-only dan menambah wrapped entry otomatis (misal `DeepSeek-V4-Flash (modlens vision)`), sedangkan model vision-native dibiarkan native-nya — solusi ringan untuk developer yang ingin 'mata' di agen tanpa melatih ulang model.",
                                                                                                                                                                                                                                ],
                                                                                                                                                                                                                            },
