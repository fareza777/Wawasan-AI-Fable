  ...
  },
  {
    ...
    },
    {
      ...
      },
      {
        slug: "sol-pi",
        name: "SoL-Pi",
        tagline: "Efisiensi coding agent dari riset NVIDIA Research yang mengurangi token tanpa mengurangi output",
        tags: ["AI Agent", "Developer Tool", "TypeScript", "Open Source"],
        score: 8.7,
        scores: [
          { label: "Kemudahan Setup", value: 9.0 },
          { label: "Fitur & Ekstensibilitas", value: 8.5 },
          { label: "Komunitas & Momentum", value: 8.5 },
          { label: "Dokumentasi", value: 9.2 },
          { label: "Kesiapan Produksi", value: 8.8 },
        ],
        summary:
